	...
	public class LineSegment {
		...
		public static List<LineSegment> VisibleLineSegments(List<Edge> edges) {
			...
			foreach (Edge edge in edges) {
				if (edge.Visible()) {
					Godot.Vector2 p1 = edge.ClippedEnds[LR.LEFT];
					Godot.Vector2 p2 = edge.ClippedEnds[LR.RIGHT];
		...
		public Godot.Vector2 p0;
		public Godot.Vector2 p1;

		public LineSegment (Godot.Vector2 p0, Godot.Vector2 p1) {
			this.p0 = p0;
			this.p1 = p1;
		}
	}
